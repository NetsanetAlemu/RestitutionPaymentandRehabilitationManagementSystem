...
-- Notifier sees land info to specify which land the project is going to settle in
-- CREATE A FUNCTION WHICH SELECT THE OPTIANS OF LANDS WHICH ARE APPROPRIATE TO THE LAND REQUEST
GO
...
GO
CREATE FUNCTION Compensation.fnTotalComp(@landOwnerID INT ,@landid INT)
RETURNS FLOAT
AS
BEGIN
	DECLARE @total FLOAT
