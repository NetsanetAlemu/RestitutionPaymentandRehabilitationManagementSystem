...
WHERE 
  ...
  GO
  -- VIEWS TOTAL COMPENSATION THAT'S GOING TO BE PAID TO HIM BY PASSING HIS ID
  -- 1. The system shall retrieve all information about a project.
...
WHERE 
 ...
 -- 2. The system shall retrieve all information about the experts who are involved in compensation and rehabilitation services.
...
-- 3. The system shall retrieve if the project is governmental or non-governmental.
